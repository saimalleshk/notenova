"""
Django settings for notenova project.
...
SECRET_KEY = 'django-insecure-n4n)cu5a0si=_0r9efor^i=@0=cy#t%!yvu=_zo76_zv+2l#ci'
...
WSGI_APPLICATION = 'notenova.wsgi.application'
